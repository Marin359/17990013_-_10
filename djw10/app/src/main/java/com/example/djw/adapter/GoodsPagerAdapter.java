package com.example.djw.adapter;

import androidx.fragment.app.Fragment;
import androidx.fragment.app.FragmentManager;
import androidx.fragment.app.FragmentStatePagerAdapter;

import com.example.djw.fragment.BookCoverFragment;
import com.example.djw.fragment.BookDetailFragment;
import com.example.djw.fragment.BookttuijianFragment;
import com.example.djw.fragment.Booktppingjiaragment;
...
public class GoodsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) { // 第一页展示书籍封面
            ...
            return new BookttuijianFragment();
        } else if (position == 3) { // 第二页展示书籍详情
            return new Booktppingjiaragment();
        }
        return new BookCoverFragment();
    }
