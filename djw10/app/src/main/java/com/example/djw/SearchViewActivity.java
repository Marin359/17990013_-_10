...
import com.example.djw.util.DateUtil;
import com.example.djw.util.MenuUtil;
...
public class SearchViewActivity extends AppCompatActivity {
    ...
    private String[] hintArray = {"杜佳伟", "17990013", "iphone8 plus", "iphone7", "iphone7 plus"};
